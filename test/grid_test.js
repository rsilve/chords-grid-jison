...
exports.jison = {
    ...
    chordDetail: function (test) {
        test.expect(6);
        var rows = grid.parse("Am/Gb");
        test.ok(rows);
        test.equal(rows[0][0].chords[0].chord.raw, "Am/Gb");
        test.equal(rows[0][0].chords[0].chord.note, "A");
        test.equal(rows[0][0].chords[0].chord.note_modifier, "m");
        test.equal(rows[0][0].chords[0].chord.base_note, "G");
        test.equal(rows[0][0].chords[0].chord.base_note_modifier, "b");
        test.done();
    },
